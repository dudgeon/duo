...
**Last updated:** 2026-06-07 (**P2 seams complete on dev** — registry adoption, `mainWindow` global deleted, gate baseline 0; P2 live-smoke + P3 pending; Cut 1 merge + run-on-`main` pending). Update this table at each seam/cut boundary; lessons accrue in Appendix E.
