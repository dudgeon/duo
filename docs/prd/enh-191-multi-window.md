...
**Last updated:** 2026-06-07 (**P3 seams COMPLETE on dev** — the `event.sender` sweep; registry-of-one read-model; 1045 tests, gate 0; adversarial-verify + Cut-2 smoke pending; Cut 1 merge + run-on-`main` pending). Update this table at each seam/cut boundary; lessons accrue in Appendix E.
