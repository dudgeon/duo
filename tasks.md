...
**Status:** 🆕 Filed 2026-06-23 (decisions locked; pre-build). **Priority:** P2. **Effort:** L. **PRD:** [docs/prd/enh-231-async-catchup-home.md](docs/prd/enh-231-async-catchup-home.md). **Decision playground:** [docs/research/async-catchup-home.html](docs/research/async-catchup-home.html) (PR #108). **Extends:** ENH-212 (Home re-entry surface), ENH-225 (attention hooks), the `claude-session-tracker.ts` JSONL reader. **Ticket note:** allocated above this branch's committed max (ENH-230); siblings ≤ ENH-230 — renumber on collision.
