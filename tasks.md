...
**Status:** 🚧 In progress 2026-06-20 — **spec locked** (10 decisions, all recommendations + 2 owner notes) · **Tier 1 (engine + CLI) built** (typecheck clean; 55 cron unit tests + full suite 1626 green; CLI + 4-surface sync done). **Owed:** live socket/tab-spawn verification on a Mac dev session, then Tier 2 (Home surface) + ENH-223 (attention badge). **Priority:** owner-TBD (feature sprint). **Effort:** L. **PRD:** `docs/prd/enh-221-scheduled-sessions.md` (§9 = Tier 1 impl notes).
