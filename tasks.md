...
- **D1 approach = inline (B)** ✓ — but owner disliked the v1 form UI; 4 new treatments in `worktree-create-ui.html` (A one-line · B name+Create/progressive · C roomy-widened · D plain-language sentence). **OPEN: pick the form UI.**
