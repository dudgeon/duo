...
**Status:** ⏳ Open — decisions FINAL (owner playground submission, 2026-06-24); PRD written; build not started. **Priority:** TBD (owner-requested). **Effort:** M (view) + M (rollup-lifecycle change — typed-note model). **Filed** 2026-06-24. **Extends** ENH-229 (rollup family). **Playground:** [`docs/research/vault-inbox-rollups-view.html`](docs/research/vault-inbox-rollups-view.html) (decision artifact, rule 11). **PRD:** [`docs/prd/enh-228-vault-view.md`](docs/prd/enh-228-vault-view.md).
