...
**Status:** 🚧 In progress — implementation landed across all 11 PRD steps + **live-verified in dev** (2026-06-12). Typecheck + **1285 unit tests green**. Owner `/smoke-walk` paste-back still owed before a cut. PRD at [docs/prd/enh-212-home.md](docs/prd/enh-212-home.md).
