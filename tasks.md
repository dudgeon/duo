...
**Status:** ✅ Shipped 2026-07-13 — merged via [PR #132](https://github.com/dudgeon/duo/pull/132) (PR-3 of the ENH-266 OKF/Obsidian-compat family). **Priority:** P2. **Effort:** S.
...
**Status:** ✅ Shipped 2026-07-13 — merged via [PR #132](https://github.com/dudgeon/duo/pull/132) (PR-3 of the ENH-266 OKF/Obsidian-compat family). **Priority:** P2. **Effort:** M.
...
**2026-07-09 (review follow-up) — `skill/references/vault-guide.html` ch. 12's migration section documents a not-yet-shipped CLI flag.** The "Migrating a pre-existing OKF vault to frontmatter markdown links" section instructs `duo vault relink --frontmatter`, but `--frontmatter` did not exist on `duo vault relink` anywhere in the repo at review time — flagging that the merge order needed to be enforced: ENH-266a before this PR. **Resolved 2026-07-13:** the actual merge order was [PR #131](https://github.com/dudgeon/duo/pull/131) (ENH-266a, ships `--frontmatter`) → [PR #130](https://github.com/dudgeon/duo/pull/130) → [PR #132](https://github.com/dudgeon/duo/pull/132) (this PR), so ch. 12 documents a real, shipped command on `main`.
