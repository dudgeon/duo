...
**Status:** 🚧 In progress — implementation + round-2/3 feedback + open-items round all landed + live-verified; **v0.10.3 smoke-walk: 5 PASS / 1 SKIP (FORK-1, now fixed below)**. (2026-06-13, `claude/gifted-torvalds-b58b02`.) **1294 unit tests green.** Ships as **v0.10.3** (a PATCH — latest tag v0.10.2; owner decision 2026-06-13, NOT a minor). PRD at [docs/prd/enh-212-home.md](docs/prd/enh-212-home.md).
