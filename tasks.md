...
**Status:** 🆕 Filed (2026-06-14, owner-noticed during ENH-216 walk). **Priority:** P1 for OKF (portability is the whole point). **Effort:** S (gitignore) / S–M (suppress-for-vaults) / M (relocate to Duo storage).
