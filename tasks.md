...
**Status:** 🚧 In progress — implementation + round-2/3 feedback + open-items round all landed + live-verified (2026-06-13, ~19 commits on `claude/gifted-torvalds-b58b02`). **~1291 unit tests green.** PRD at [docs/prd/enh-212-home.md](docs/prd/enh-212-home.md).
...
**→ Next: `/smoke-walk` → propose `cut-version`.**
