...
| **26** | **Navigator polish & ergonomics** (was the `backlog-nav-polish` item — promoted to a stage 2026-04-27) | 🔄 **PR 1 (row-interaction cluster — items 1, 1b, 6, 7) at [duo#28](https://github.com/dudgeon/duo/pull/28) awaiting merge.** **PR 2 (ENH-010 Pinned files & folders section) in scope for v0.5.0.** PR 3 (ambient signals + Go-to path — items 2/3/4/5(BUG-007)/8) deferred to v0.5.1+. PRD lives inline in the stage card. | **L2** |
